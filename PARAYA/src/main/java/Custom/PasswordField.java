...
public class PasswordField extends JPasswordField {
    ...
    private Color lineColor = colores.azul;
    ...
    public PasswordField() {
        ...
        setSelectionColor(colores.azul);
        ...
        String assetsPathEye = currentDir + File.separator + "src" + File.separator + "main" + File.separator + "java" + File.separator + "Assets" + File.separator + "eye.png";

        eye = new ImageIcon(assetsPathEye).getImage();
    ...
    private void createShowHide(Graphics2D g2) {
        ...
        g2.drawImage( eye, x, y, null);
    }

    private void createHintText(Graphics2D g2) {
        Insets in = getInsets();
        g2.setColor(colores.azulHover);
